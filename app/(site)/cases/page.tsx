    ...
    <>
      ...
      <Section title="케이스 상세 레이아웃(템플릿)">
        <div className="space-y-6">
          <div className="rounded-xl bg-white border border-navy/10 p-6" id="template">
            <h3 className="text-lg font-bold mb-4">예시 케이스 상세</h3>
            <div className="space-y-3 text-sm text-navy/80">
              <p><strong>1) 클라이언트 소개</strong> — 창원 전골 전문점</p>
              <p><strong>2) 과제/문제 상황</strong> — 리뷰 부족, 지역 인지도 낮음</p>
              <p><strong>3) 진행 전략</strong> — 타깃 카테고리 블로거 집중 매칭</p>
              <p><strong>4) 실행 내용</strong> — 초청 메시지·일정 조율, 가이드 공유</p>
              <p><strong>5) 결과</strong> — 리뷰 수 3배, 저장 수 2배</p>
              <p><strong>6) 사장님 한 줄 후기</strong> — “생각보다 빠르게 효과를 봤어요.”</p>
            </div>
          </div>
        </div>
      </Section>
